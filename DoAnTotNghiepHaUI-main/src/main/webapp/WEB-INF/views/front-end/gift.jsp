													...
													<c:choose>
														...
														<c:otherwise>
															<img class="img" align="left"
																style="outline: 0px; border-width: 1px; border-style: solid; border-color: gray; max-width: 100%; border-radius: 5px; padding: 5px; margin-right: 15px; width: 280px;" src="${pageContext.request.contextPath}/images/${gifts.gift.giftImages.get(0).path }" alt="">
														</c:otherwise>
													</c:choose>
												</a>
											</p>
													...
													<c:forEach items="${gifts.product}" var="product">
														<li style="outline: 0px; float: left; text-align: center;">
															<a href="${pageContext.request.contextPath}/products/${product.seo }"
																...
																<img src="${pageContext.request.contextPath}/images/${product.productImages.get(0).path }"
																alt=""
